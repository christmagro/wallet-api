package com.chris.wallet.api.aspect;
...
public class Logging {
    ...
    private static final String POINTCUT = "within(com.chris.wallet.api.controller.*)";

    @Around(POINTCUT)
    @SneakyThrows
    public Object logAroundExec(ProceedingJoinPoint pjp) {
        log.debug("Logging Before {}", constructLogMsg(pjp));
        var proceed = pjp.proceed();
        log.debug("Logging After {} with result: {}",constructLogMsg(pjp), proceed.toString());
        return proceed;
    }
